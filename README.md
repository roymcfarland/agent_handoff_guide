...
Created by **[Roy McFarland](https://github.com/roymcfarland)** (Worksmith Labs) — and built *with* the methodology it documents: every change to this repo ships as an Advisor-scoped slice, an independent verification, and a human merge. The [merged-PR history](https://github.com/roymcfarland/agent_handoff_guide/pulls?q=is%3Apr+is%3Amerged) is the working demonstration.
