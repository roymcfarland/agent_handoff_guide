...
The copy-paste prompts, templates, and drop-in docs from [www.worksmithlabs.com](https://www.worksmithlabs.com/) — the Agent Handoff Framework by [Roy McFarland](https://github.com/roymcfarland) — emitted as plain markdown so you can vendor, diff, and fetch them directly.
