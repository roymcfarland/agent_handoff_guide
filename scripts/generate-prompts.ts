...
const readme = [
  ...
  "",
  `The copy-paste prompts, templates, and drop-in docs from [${SITE.replace("https://", "")}](${SITE}/) — the Agent Handoff Framework by [Roy McFarland](https://github.com/roymcfarland) — emitted as plain markdown so you can vendor, diff, and fetch them directly.`,
  "",
...
const llms = [
  ...
  "",
  "Author: Roy McFarland (https://github.com/roymcfarland)",
  `Site: ${SITE}/`,
  `Repository: ${REPO}`,
