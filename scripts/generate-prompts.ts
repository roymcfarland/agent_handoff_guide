...
const readme = [
  ...
  "",
  `The copy-paste prompts, templates, and drop-in docs from [${SITE.replace("https://", "")}](${SITE}/), emitted as plain markdown so you can vendor, diff, and fetch them directly.`,
  "",
...
const llms = [
  ...
  "",
  "> A working guide for shipping real software with AI coding agents: three roles (an Advisor scopes slices and drafts prompts, a Builder executes, a Verifier returns evidence-backed verdicts — a human merges), a three-file document schema (PROJECT.md / CHANGELOG.md / HANDOFF.md), a copy-paste prompt library, and failure-mode guardrails. The site is maintained with the framework it documents; its merged-PR history is the public audit trail.",
  "",
  `Site: ${SITE}/`,
  `Repository: ${REPO}`,
